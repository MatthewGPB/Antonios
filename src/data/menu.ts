...
export const sourdoughAndBreads: MenuSection[] = [
  {
    ...
    items: [
      ...
      { name: 'Everything Sourdough', description: 'Our sourdough crusted in everything-bagel seasoning', tag: 'Popular' },
      { name: 'Sourdough Boule', description: 'Round artisan loaf, perfect for the table', price: '$10.00' },
      { name: 'Sliced Sandwich Sourdough', description: 'Soft-crust pan loaf, great for toast', price: '$10.00' },
    ],
  },
  {
    title: 'Artisan & Specialty Breads',
    note: '30 flavored breads on rotation — with even more on the weekend. These are the regulars; ask what came out of the oven today.',
    items: [
      { name: 'Semolina', description: 'Golden Italian classic with a tender crumb' },
      { name: 'Italian', description: 'Everyday loaf, crusty outside and soft inside' },
      { name: 'Italian Seeded', description: 'Classic Italian topped with sesame seeds' },
      { name: 'Cranberry Walnut', description: 'Sweet-tart cranberries and toasted walnuts' },
      { name: 'Asiago Cheese', description: 'Baked with real Asiago through and through' },
    ],
  },
  {
    title: 'Daily Bakes',
...
export const breakfastAndDesserts: MenuSection[] = [
  {
    title: 'Scones',
    note: 'Buttery and baked fresh — flavors rotate through the week.',
    items: [
      { name: 'Fresh Organic Blueberry', tag: 'Popular' },
      { name: 'Fresh Cranberry' },
      { name: 'Almond Apricot' },
  ...
  {
    title: 'Cinnamon Buns',
    note: 'Warm out of the oven first thing in the morning.',
    items: [
      { name: 'Glazed', tag: 'Signature' },
      { name: 'Icing' },
  ...
  },
  {
    title: 'Danish',
    items: [
      { name: 'Cheese', tag: 'Popular' },
      { name: 'Cheese & Fresh Blueberries' },
      { name: 'Cheese & Fresh Mixed Berry' },
      { name: 'Guava' },
      { name: 'Lemon' },
      { name: 'Apple' },
      { name: 'Blueberry' },
  ...
  {
    title: 'Croissants',
    note: 'Flaky, buttery, and baked daily.',
    items: [
      { name: 'Butter', tag: 'Signature' },
      { name: 'Chocolate' },
      { name: 'Almond' },
      { name: 'Cookie Dough' },
      { name: 'Dubai Chocolate', tag: 'Popular' },
      { name: 'Strawberry' },
      { name: 'Guava & Cheese' },
    ],
  },
  {
    ...
    note: 'A full breakfast in a flaky croissant.',
    items: [
      { name: 'Spinach & Feta' },
      { name: 'Bacon & Jalapeño Cheddar', tag: 'Popular' },
      { name: 'Ham & Swiss' },
      { name: 'Pepperoni & Imported Provolone' },
    ],
  },
  {
    title: 'Turnovers',
    note: 'Flaky pastry with real fruit filling.',
    items: [
      { name: 'Apple' },
      { name: 'Strawberry' },
      { name: 'Cherry' },
  ...
  },
  {
    title: 'Strudel',
    items: [
      { name: 'Apple', tag: 'Signature' },
      { name: 'Cherry & Cheese' },
      { name: 'Blueberry & Cheese' },
      { name: 'Guava & Cheese' },
      { name: 'Fresh Strawberries & Nutella', tag: 'Popular' },
    ],
  },
  {
